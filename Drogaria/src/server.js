...
server.put("/usuarios/:id", (req, res) => {
  ...
  if (idUsuario === -1) {
    ...
    //atualiza o nome:
    dados.users[idUsuario].nome =
      atualizarUsuario.nome || dados.users[idUsuario].nome;

    //atualiza a idade:
    dados.users[idUsuario].idade =
      atualizarUsuario.idade || dados.users[idUsuario].idade;

    //atualiza o curso
    dados.users[idUsuario].curso =
      atualizarUsuario.curso || dados.users[idUsuario].curso;
